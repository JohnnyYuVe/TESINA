...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <head>
      ...
      <link rel="stylesheet" href="http://localhost/php_program/GameOfHistory/CSS_FILE/MAIN_STYLE.css">
  </head>
        ...
        <div class="Disposizione">
          ...
          ?>
              <div class="articolo Font_For_Text">
                <?php 
                  echo'<form action="MAIN.php?id='.$ARRAY_ART[0].'"'.'method="POST" id='. $ARRAY_ART[0] .'>';
                ?>
                <img src='<?php echo  $ARRAY_ART[5]; ?>' alt="Foto articolo"> 
                <p>
                  ID:  <?php echo $ARRAY_ART[0]; ?></br>
                  CAT:  <?php echo $ARRAY_ART[1]; ?></br> 
