...
function ADD_PUNTI_FEDELTA($DOC,$ID_CLI,$SPESA){
  ...
  for($I=0;$I<$F;$I++){
     ...
     if(strcmp( $ARR_USER[1] ,$ID_CLI)==0){
      ...
      echo"<p>";
      echo"PT_HISTORY:".$PT_HISTORY."</br>";
      echo"prima:".$DOC->Utente[$I]->Punti_History."</br>";
      $DOC->Utente[$I]->Punti_History= $ARR_USER[9]+$PT_HISTORY;

      echo"dopo:".$DOC->Utente[$I]->Punti_History."</br>";
      echo"<p>";
