...
<body>
      <div class="MAIN_Conteiner">
                ...
                <div class="BackGround_Button ">
                  <button type="button" class="Big_Button Font_For_Text" onclick="location.href='http://localhost/php_program/GameOfHistory/PHP_FILE/MAIN.php'"><span>Go Home</span> </button>
                </div>
